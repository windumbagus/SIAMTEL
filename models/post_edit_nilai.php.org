...
require_once("../config/koneksi.php"); //Wajib 
	...
	$sql = mysql_query(" UPDATE nilai set disiplin='$disiplin',sopan='$sopan',personal='$personal',tim='$tim',adaptasi='$adaptasi',tj='$tj',jujur='$jujur',n_akhir='$n_akhir'WHERE username='$username'")
